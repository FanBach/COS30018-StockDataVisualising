...
def processData(isStoredDataLocally=True, company="GOOG", startDate="2015-01-01", endDate="2023-01-01", dataSource = "yahoo", 
...
def mean_absolute_percentage_error(predicted, actual):
  ...
  # Avoid division by zero for zero actual values
  mape = [0 if a == 0 else abs((a - p) / a) * 100 for a, p in zip(actual, predicted)]
